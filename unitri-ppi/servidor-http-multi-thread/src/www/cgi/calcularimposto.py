...
print('    </head>');
print('    <body>');
print('        <form action="/cgi/calcularimposto.py">');
print('        <p>');
print('            Mês 1: <input name="firstMonth" type="text" value=' + str(firstMonth) + ' required><br>');
print('            Mês 2: <input name="secondMonth" type="text" value=' + str(secondMonth) + ' required><br>');
print('            Mês 3: <input name="thirdMonth" type="text" value=' + str(thirdMonth) + ' required>');
print('        </p>');
print('        <p>');
