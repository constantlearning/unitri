...
namespace AdalineV1.Forms
{
    public partial class FrmTreinamento : Form
    {
        ...
        private void btnTreinar_Click(object sender, EventArgs e)
        {
            ...
            Neuron redeA = new Neuron(vetoresTreinamento, Fontes.SaidasA);
            Neuron redeB = new Neuron(vetoresTreinamento, Fontes.SaidasB);
            Neuron redeC = new Neuron(vetoresTreinamento, Fontes.SaidasC);
            Neuron redeD = new Neuron(vetoresTreinamento, Fontes.SaidasD);
            Neuron redeE = new Neuron(vetoresTreinamento, Fontes.SaidasE);
            Neuron redeJ = new Neuron(vetoresTreinamento, Fontes.SaidasJ);
            Neuron redeK = new Neuron(vetoresTreinamento, Fontes.SaidasK);
